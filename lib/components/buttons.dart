...
Widget setButton({String text, Function function, bool outline = false, bool uppercase = false, IconData icon}) =>
    Container(
...
Widget setButtonText({String text, Function function, bool underline = false, bool uppercase = false, Color color, IconData icon}) =>
  FlatButton(
    onPressed: function?? (){}, 
    child: Padding(
