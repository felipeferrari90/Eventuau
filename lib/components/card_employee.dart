     ...
     child: Column(
       ...
       children: [
         ...
         Padding(
           ...
           child: Text("ultimo trabalho: 2sem", style: TextStyle( fontSize: 12, fontWeight: FontWeight.w500, color: Colors.black54)),
         ), 
         Row(
           children: [
             Padding(
             ...
             Padding(
               ...
               child: CircleAvatar( backgroundColor: Colors.green[400], radius: 3,)
             ),
             Padding(
               padding: EdgeInsets.fromLTRB(2, 0, 0, 4),
               child: Text("disponivel", style: TextStyle( fontSize: 10, fontWeight: FontWeight.w500, color:  Colors.black54)),
             )
           ],
         ),
         Row(
           children: [
             ...
             Padding(
               ...
               child: Text("R\$ 1000-2300", style: TextStyle( fontSize: 12, fontWeight: FontWeight.w500, color: primaryColor)),
             ), 
           ],
         ),    
         Padding(
