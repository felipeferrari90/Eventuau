...
class _EventNewScreenState extends State<EventNewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          EventUauAppBar(title: "Criar Evento", username: "Antonio conceicao"),
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          setInputForm(context,
              labeltext: "Data do evento:",
              keyboardType: TextInputType.datetime),
          setInputForm(context,
              labeltext: "Hora do evento:", keyboardType: TextInputType.number),
          setInputForm(context,
              labeltext: "Duração Minima", keyboardType: TextInputType.number),
          setInputForm(context,
              labeltext: "Duração Maxima", keyboardType: TextInputType.number),
          ListTile(
            leading: Text(
              "Status Contratacao: ",
