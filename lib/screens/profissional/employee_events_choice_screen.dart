...
class EmployeeEventChoiceScreen extends StatefulWidget {
  ...
  @override
  _EmployeeEventChoiceScreenState createState() =>
      _EmployeeEventChoiceScreenState();
}
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  "comece a curtir eventos para ser contratado.",
                  style: TextStyle(
                      fontSize: 24,
                      color: primaryColor,
              ...
              Padding(
                ...
                child: Text(
                    "Deslize o card do evento á direita para curtir ou a esquerda para rejeitar a proposta, ",
                    style: TextStyle(
                        fontSize: 16,
