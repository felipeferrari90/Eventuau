...
class EventoModel{
  ...
  factory EventoModel.fromMap(Map<String, dynamic> json) => EventoModel(
     ...
     statusEvento: EnumToString.fromString(StatusEvento.values, json["statusEvento"]),
     ...
     statusContratacaoEvento: EnumToString.fromString(StatusContratacaoEvento.values,  json["statusContratacaoEvento"]),
  ...
  Map<String, dynamic> toMap() => {
      ...
      "statusEvento" : EnumToString.convertToString(this.statusEvento , camelCase: false),
      "statusContratacaoEvento" : EnumToString.convertToString(this.statusContratacaoEvento , camelCase: false),
      ...
      "funcionariosQueCurtiram": this.funcionariosQueCurtiram,   //equivalente a uma lista de reserva de funcionarios (que nao foram contratados)
  };
